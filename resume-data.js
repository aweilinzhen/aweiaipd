window.RESUME_DATA = {
  ...
  summary: [
    "软件工程本科，人工智能硕士在读，具备 Java 开发背景及 6 年 B端/PaaS 产品经验。具备扎实的底层技术思维，能顺畅地与研发团队进行技术对齐与方案落地。",
    "硕士期间系统学习机器学习、NLP、高级算法与数据挖掘等 AI 核心课程，研究方向聚焦自然语言驱动的业务流程自动化；具备 Workflow、数据建模、API 编排及权限体系等复杂平台能力设计经验。",
  ...
  experience: [
    {
      ...
      bullets: [
        "参与 PaaS 低代码平台从 0–1 建设，负责审批流、Workflow 等核心底座能力的规划与设计，持续推动平台能力标准化、产品迭代及商业化落地；任职期间公司完成纳斯达克上市，个人连续 2 次获评 S 级优秀绩效。",
        "负责跨团队需求评审、技术方案对齐及研发交付，协调研发、测试与设计资源推进复杂模块落地；同时带教 2 名助理产品经理，参与需求分析、产品设计及项目推进。",
